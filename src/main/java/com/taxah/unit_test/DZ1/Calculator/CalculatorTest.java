...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        double price = 1;  int discount = 75;
        try {
            System.out.printf("Discount calculation: from price %.1f discount = %d%% total: %.1f\n",
                    price, discount, Calculator.calculatingDiscount(price, discount));
